...
<head>
    <meta charset="UTF-8">
    <title>Preview Laporan Mesin Produksi</title>
...
<div class="download-btn">
    <a href="{{ url('/laporan/id/'.$laporan->id.'/export-pdf') }}" target="_blank">
        ⬇ Download PDF
    </a>
</div>
@endif
...
<div class="page">
    ...
    <div class="header">
        <div class="header-logo">
            <img src="{{ public_path('assets/logo-instansi.png') }}" alt="Logo Instansi">
        </div>
